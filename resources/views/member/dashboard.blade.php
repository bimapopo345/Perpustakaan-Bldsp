                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        <thead class="bg-gray-50">
                            <tr>
                                ...
                                <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Tanggal Kembali (Rencana)</th>
                                ...
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm">
                                        @if($peminjaman->tanggal_dikembalikan)
                                            <span class="text-gray-500">{{ $peminjaman->tanggal_dikembalikan->format('d M Y') }}</span>
                                        @elseif($peminjaman->status === 'menunggu_konfirmasi_kembali')
                                            <span class="text-indigo-600">Menunggu Konfirmasi</span>
                                        @else
